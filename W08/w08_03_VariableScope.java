...
public class w08_03_VariableScope {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("y in merhod = " + y);
       
        if (true) {
         int c = 300;    // Local Variable วงจรชีวิตของตัวแปร c จะทำงานเฉพาะในบล็อกนี้เท่านั้น
            System.out.println("c in if = " + c);
             System.out.println("a aftre if = " + obj.a);
             System.out.println("x = " + x);
        }
            System.out.println("c in method = " + y);
             System.out.println("b after if = " + obj.b);  
    }
