...
static void displayarray(int[] number){
  ...
  System.out.println();
    ...
    public static void main(String[] args) {
        // 1) Method สำหรับหาค่ามากที่สุด
System.out.println("ค่ามากสุดคือ [10, 20] คือ " + findMax(10 , 20));     

        // 2) Method สำหรับหาค่าน้อยที่สุด
    System.out.println("ค่าน้อยสุดคือ [10, 20] คือ " + findMin(10 , 20)); 

        // 3) Method สำหรับหาค่ามากที่สุด โดยรับค่า 3 ตัว
        System.out.println("ค่ามากสุดคือ [100, 15, 20] คือ " + findMax(100 , 15 ,20));  

        // 4) Method สำหรับหาค่าน้อยที่สุด โดยรับค่าเป็น array
       int[] nunbers = {10, 20, 30, 40, 50};
        displayarray(nunbers);
        System.out.println("Min number in array is " + findMin(nunbers));
