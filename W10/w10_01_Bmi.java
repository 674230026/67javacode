...
public class w10_01_Bmi {
    public static void main(String[] args) {
        ...
        double heightMCM = scanner.nextDouble();
        //แปลงค่าส่วนุสูงจากเมตรให้เป็นgเซนติเมตร
       Double heightM = heightMCM/100;
        // คำนวณค่า BMI
        ...
        // ตรวจสอบสถานะ BMI
        if (bmi<18.5)  {
            System.out.println("คุณมีน้ำหนักน้อยกว่าเกณฑ์ : ไอแห้ง");
        } else if (bmi>=18.5 && bmi<=24.9) {
            System.out.println("คุณมีน้ำหนักน้อยปกติ : ไอแห้ง");
        } else if (bmi>=25 &&bmi <= 29.9) {
            System.out.println("คุณมีน้ำหนักเกิน : มึงอ้วนแล้วนะรู้ตัวด้วย");
        } else {
            System.out.println("คุณมีน้ำหนักเกินกว่าปกติมาก : (ไอเชี้ยอ้วน");
        }
        scanner.close();
    }
}